  ...
  return (
    <div className="fixed top-0 left-1/2 -translate-x-1/2 z-[400] flex flex-col w-full max-w-[430px]"
      ...
      <div className="px-8 pt-6 pb-3 shrink-0">
        ...
        <p className="text-[10px] text-warm-gray text-right mt-1">{step + 1}/{TOTAL_STEPS}</p>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 animate-fade-in overflow-y-auto" key={step}>
        ...
        {step === 1 && (
          <>
            ...
            <p className="text-[10px] text-gold-light tracking-[3px] font-heading uppercase mb-2">
            ...
            <p className="text-[10px] text-gold-light text-center mt-1">
        ...
        {step === 5 && (
          <>
            <p className="text-[10px] text-gold-light tracking-[3px] font-heading uppercase mb-3">
              Îndreptarul complet
            </p>
              ...
              {[
                ...
                <div key={i} className="flex items-center gap-4 rounded-xl p-3.5"
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[10px] text-warm-gray">{s.detail}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        {step === 6 && (
          <>
            ...
            <div className="max-w-[320px] w-full">
              <p className="text-[10px] text-gold tracking-[2px] font-heading mb-2">DIMINEAȚA</p>
              ...
              <p className="text-[10px] text-gold tracking-[2px] font-heading mb-2">SEARA</p>
          ...
          <>
            ...
            <div className="flex gap-3 max-w-[320px] w-full mb-4">
              <div className="flex-1 rounded-xl p-4 text-center"
                style={{ background: "#1A141066", border: "1px solid #C5A55A22" }}>
                <p className="text-[10px] text-warm-gray mb-1">Săptămânal</p>
              ...
              <div className="flex-1 rounded-xl p-4 text-center relative"
                ...
                <p className="text-[10px] text-gold-light mb-1">Anual</p>
